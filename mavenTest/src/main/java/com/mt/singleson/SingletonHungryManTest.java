...
public class SingletonHungryManTest {
	...
	InstantiationException, NoSuchMethodException, InvocationTargetException, NoSuchFieldException{
	 ...
	 private Object createAnotherInstanceUsingRelection() throws ClassNotFoundException, NoSuchMethodException, 
	 InstantiationException, IllegalAccessException, InvocationTargetException {
	    ...
	    private Object createAnotherInstanceUsingAnotherClassLoader() throws ClassNotFoundException, 
	    NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchFieldException {
	        // use custom class loader to load class
	        ClassLoader myLoader = getMyLoader();
	        Class<?> myClass = myLoader.loadClass("com.mt.singleson.SingletonHungryMan");
